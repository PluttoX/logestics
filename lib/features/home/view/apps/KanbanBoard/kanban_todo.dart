...
class KanbanBoardTodo extends StatefulWidget {
  const KanbanBoardTodo({super.key});

  @override
  State<KanbanBoardTodo> createState() => _KanbanBoardTodoState();
}

class _KanbanBoardTodoState extends State<KanbanBoardTodo> {
  bool todohover = false;
      ...
      children: [
        ...
        InkWell(
          ...
          child: Container(
            height: 50,
            decoration: BoxDecoration(
              color: todohover ? const Color(0xFFeff3f9) : Colors.white,
              borderRadius: BorderRadius.circular(10),
            ),
            child: Center(
              child: Text(
        ...
        //   color: hover ? Colors.deepOrangeAccent : Colors.amber,
