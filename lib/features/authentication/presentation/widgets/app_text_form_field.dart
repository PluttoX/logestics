...
class AppTextFormField extends StatelessWidget {
  ...
  AppTextFormField({
    ...
    this.labelText,
  }) :errorMessage=errorMessage == null ? errorMessage : errorMessage.isEmpty
      ? null
      : errorMessage;
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(screenHeight*004*screenHeight*004),
                        ...
                        boxShadow: Focus
                          ...
                          BoxShadow(
                            color: Theme
                                ...
                                .shadow,
                            // Shadow color
                            offset: Offset(10 / dpr,
                                10 / dpr),
                            // Shadow offset
                            blurRadius:
                            10 / dpr, // Shadow blur effect
                          ),
                        ]
                            : null,
                      ),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffix: isObscure == null
                          ...
                          icon: Icon(
                            isObscure == false ? Icons.visibility : Icons
                                .visibility_off //
                        ...
                        contentPadding: EdgeInsets.symmetric(
                            ...
                            vertical: isObscure != null ? screenHeight * 0.02 : screenHeight * 0.02),
                        hintText: hintText,
                        ...
                        enabledBorder: OutlineInputBorder(
                          borderSide: BorderSide(
                              ...
                              width: 3),
                          borderRadius:
                          BorderRadius.circular(screenHeight*004*screenHeight*004 ),
                        ),
