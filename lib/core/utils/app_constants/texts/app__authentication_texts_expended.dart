class AppAuthenticationTextsExpended {
  ////////////////authentication screens text
  //login screen text
  static const String next='Next';
  static const String automateBusiness = "Automate your\n Business";
  static const String text = "Lorem Ipsum is simply dummy text of the printing and typesetting industry.";
  ...
  static const String remeber = "Remember me";
  ...
  static const String  signeIn='Signe In';
  ...
  static const String tooManyRequests = "Too many login attempts. Try again later.";
  ...
  static const String timeoutError = "Request timeout. Please check your internet connection.";
  ...
  static const String passwordResetEmailSent = "check your email box email is sented to user";
  static const String subHeading = "enter valid email address . we will send forget password link to your account";
